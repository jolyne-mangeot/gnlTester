...
BONUS_HEADER			= ../get_next_line.h
BONUS_FILES				= ../get_next_line.c ../get_next_line_utils.c
BONUS_OBJS				= $(BONUS_FILES:../%.c=%.o)
# unique objs per BUFFER_SIZE for bonus
B1_OBJS					= get_next_line.bs1.o get_next_line_utils.bs1.o
B42_OBJS				= get_next_line.bs42.o get_next_line_utils.bs42.o
B10M_OBJS				= get_next_line.bs10M.o get_next_line_utils.bs10M.o
...
bonus_start: update
	@tput setaf 3 && printf "[Static = " && cat ../*line.c | grep -E 'static.*;' | wc -l | tr -d '\n' | xargs /bin/echo -n && printf "]\n"
